...
parser.add_argument("--output_csv", type=str, default="./output_csv/512/train/")
# ------------------------------------------------------------------------
...
def main():
    ...
    wandb.init(project=f"DINOv3 Segmentation FE to CSV {args.model_type} Images 512 Train New",
